...
namespace PersistanceLayerNoGeneric.Repositories
{
    public class StudentRepository
    {
        ...
        public Student SingeOrDefault(Expression<Func<Student, bool>> predicate)
        {
        ...
        public void RemoceChange(IEnumerable<Student> students)
        {
        ...
        {
            throw new NotImplementedException("POTE MIN AFINEIS MIA METHODO ADEIA");
        }
    }
}
